                ...
                @for($i = 0; $i<count($array); $i++)
                    <div id="container{{$i}}">
                        ...
                        <div class="text-center">
                            <button class="btn btn-success" onclick="nextWord({{$i}}, 1)"><i class="fa fa-thumbs-up" aria-hidden="true"></i> Ştiu</button>
                            <button class="btn btn-danger" onclick="nextWord({{$i}}, 0)"><i class="fa fa-thumbs-down" aria-hidden="true"></i> Nu știu</button>
                        </div>
                    </div>
                @endfor
            </div>
